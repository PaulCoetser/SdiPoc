...
export class SideBarNavComponent extends AppComponentBase {
    ...
    menuItems: MenuItem[] = [
        ...
        //new MenuItem(this.l("Onboarding"), "", "link", "/app/onboarding"),
        //new MenuItem(this.l("Notification"), "", "link", "/app/onboarding"),

        new MenuItem(this.l("Onboarding"), "Pages.Onboarding", "link", "/app/onboarding"),
